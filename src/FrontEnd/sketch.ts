...
export const HEADER = {
  ...
  LOADING_SCREEN_MESSAGES: [
    "Check out this cool loading screen lol.",
    "To win, you have to get good.",
    "Ultimate Tictactoe is better than TicTacToe",
    "Don't forget to touch grass every once in a while.",
    "Fun Fact: This font doesn't have colons.",
    "Having trouble? Skill issue.",
    "Help, I can't think of loading messages.",
    "I should probably put some actually helpful tips here.",
    "Try to direct your opponent to a square where they can't do anything.",
    "Sometimes, you can force your opponent to send you to an advantageous square.",
    "Try to place your pieces such that there are multiple ways you can score a point.",
  ],
...
export let whiteTicTac: Image,
  space: Image,
  arrows: Image,
  wasd: Image,
  tictacboard: Image,
  tictacboard_two: Image,
  tictacboard_three: Image;
...
const sketch = (p5: P5) => {
  p5.setup = () => {
    ...
    GuiManager.changeScreen(Screens.SETUP_SCREEN, p5, GameType.LOCAL);
    p5.background(255);
  };
