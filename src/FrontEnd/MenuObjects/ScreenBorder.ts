...
export default class ScreenBorder extends BaseMenuItem {
  ...
  public draw() {
    ...
    this.getSketch().rect(
      ...
      getCanvasSize() / 2,
      getCanvasSize() +
        this.borderWidthPercent * getCanvasSize() -
        this.borderWidthPercent * getCanvasSize() * 2 * this.borderPos,
      getCanvasSize() +
        this.borderWidthPercent * getCanvasSize() -
        this.borderWidthPercent * getCanvasSize() * 2 * this.borderPos,
    );
   ...
   * @returns void
   */
  public setTransitionIn(transition: boolean) {
    this.transitionInActive = transition;
  }
   ...
   * @returns void
   */
  public setTransitionOut(transition: boolean) {
    this.transitionOutActive = transition;
  }
}
