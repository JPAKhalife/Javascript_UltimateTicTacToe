...
export default class Popup extends BaseMenuItem{
    ...
    constructor(sketch: p5, xPercent: number, yPercent: number, options: PopupOptions = {}, opacity: number = 0) {
    ...
    public draw(): void {
        ...
        this.getSketch().push();
            ...
            this.getSketch().square(this.getXPercent() * getCanvasSize(), this.getYPercent() * getCanvasSize() + this.transitionY*getCanvasSize(), getCanvasSize()/2);
            ...
            this.getSketch().text("Popup Title", this.getXPercent() * getCanvasSize(), ((this.getYPercent() * getCanvasSize()) - 50) + this.transitionY * getCanvasSize(), getCanvasSize()/2 - 20, 50);
            this.getSketch().textSize(16);
            this.getSketch().text("This is a popup message. It can contain useful information for the user.", this.getXPercent() * getCanvasSize(), this.getYPercent() * getCanvasSize() + + this.transitionY * getCanvasSize(), getCanvasSize()/2 - 20, getCanvasSize()/4);
        this.getSketch().pop();
