...
export default class StartScreen implements Menu {
  ...
  public draw(): void {
    ...
    this.sketch.text(
      this.titleText,
      getCanvasSize() / 2,
      getCanvasSize() / 5 + this.animOffset,
    );
    ...
    this.sketch.text(
      this.authorText,
      getCanvasSize() / 2,
      (getCanvasSize() / 10) * 3 + this.animOffset,
    );
    ...
    this.sketch.text(
      ...
      getCanvasSize() / 2,
      getCanvasSize() / 2 + this.animOffset,
    );
  ...
  private checkAnimationConditions(): void {
    if (
      ...
      this.startMessageAlpha =
        128 + 128 * this.sketch.sin(this.sketch.millis() / 500);
    }
  }
      ...
      getCanvasSize() *
        this.sketch.sin(
          (this.animationCounter +
            (100 * this.sketch.asin(3 / 4) + 200 * this.sketch.PI)) /
            100,
        ) -
      (getCanvasSize() / 4) * 3;
