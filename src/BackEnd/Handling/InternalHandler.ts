 ...
 */
export async  function handleConnectionExpiry(redisClient: Redis, expiredKey: string) {
    console.log("Disconnecting");
    disconnect(redisClient, expiredKey);
}