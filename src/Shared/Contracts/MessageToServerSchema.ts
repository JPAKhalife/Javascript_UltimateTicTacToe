...
export const BaseRequest = z.object({
  messageID: z
    .string()
    .min(VALIDATION.MIN_STANDARD_LENGTH)
    .max(VALIDATION.MAX_STANDARD_LENGTH), // All messages should have a message ID - at most 50 characters
  type: z
    .string()
    .min(VALIDATION.MIN_STANDARD_LENGTH)
    .max(VALIDATION.MAX_STANDARD_LENGTH), // All messages should have a type - at most 20 characters
...
export const LobbySearchRequest = AuthenticatedRequest.extend({
  parameters: z.object({
    playerNum: z
      .number()
      .int()
      .lte(GAME_CONSTANTS.MAX_PLAYER_CAP)
      .gte(0)
      .optional(),
    levelSize: z
      .number()
      .int()
      .lte(GAME_CONSTANTS.MAX_LEVELSIZE_CAP)
      .gte(0)
      .optional(),
    gridSize: z
      .number()
      .int()
      .lte(GAME_CONSTANTS.MAX_GRIDSIZE_CAP)
      .gte(0)
      .optional(),
    joinedPlayers: z
      .number()
      .int()
      .lte(GAME_CONSTANTS.MAX_PLAYER_CAP + GAME_CONSTANTS.MAX_SPECTATOR_CAP)
      .gte(0)
      .optional(),
    ...
    maxListLength: z
      .number()
      .int()
      .lte(VALIDATION.MAX_RESULTS)
      .gte(0)
      .optional(),
    searchListLength: z
      .number()
      .int()
      .lte(VALIDATION.MAX_SEARCH_LIMIT)
      .gte(0)
      .optional(),
  }),
});
