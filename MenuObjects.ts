...
class Floater 
{
    ...
    constructor(image : p5.Image, width: number, length: number) {
        this.floater = new Img(image,this.x,this.y,this.width,this.length);
        this.vx = 0;
        this.vy = 0;
        this.sv = 0;
        this.opacity = 255;
    ...
    init(): void 
    {
        ...
        this.floater.setX(this.randomCoord());
        this.floater.setY(this.randomCoord());
    }
    ...
    draw(): void
    {
        ...
        this.floater.render();
        this.floater.move(this.vx,this.vy);
        if (this.doBounce()) {
            this.bounce();
        }
    }
    ...
    bounce() {
        ...
        if (this.floater.getX() + this.floater.getWidth()/2 > getCanvasSize() || this.x - this.width/2 < 0) {
            this.vx = this.vx*-1;
        }
