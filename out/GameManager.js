...
var TicTac_1 = __importDefault(require("./TicTac"));
var TicTac_2 = require("./TicTac");
//This is a constant that holds the types of games that can exist
var GameType;
(function (GameType) {
    GameType[GameType["LOCAL"] = 0] = "LOCAL";
    GameType[GameType["ONLINE"] = 1] = "ONLINE";
})(GameType || (exports.GameType = GameType = {}));
//This class activates as soon as a game is started
var GameManager = /** @class */ (function () {
    function GameManager(gameType, gridSize, gridLevels) {
        if (gameType === void 0) { gameType = GameType.LOCAL; }
        if (gridSize === void 0) { gridSize = TicTac_2.DEFAULT_GRID_SIZE; }
        ...
        this.board = new TicTac_1.default(gridLevels); //TODO: Create a constant for the number of tictacs inside tictacs u
        //This is used to keep track of the current player's turn
        this.turn = 0;
        this.isWon = false;
        this.playerNumber = TicTac_2.DEFAULT_PLAYER_NUMBER;
    }
     ...
     * @returns {TicTac}
     */
    GameManager.prototype.getBoard = function () {
        return this.board;
    };
    /**
     * @method getTurn
